...
def scrape(url, category_label, sport_label, gender_label, store_name='Fairplay'):
    ...
    try:
        print(f"\n--- Iniciando {store_name}: {gender_label} - {sport_label} ---")
        ...
        print(f"\n  - {total_models} productos detectados. Iniciando Deep Scraping...")
        ...
        print(f"\n✅ {store_name} finalizado: {len(all_products)} registros válidos.")
